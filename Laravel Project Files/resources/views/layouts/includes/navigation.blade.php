<nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            <image src="{{url('/images/hilliardslogo.png')}}" alt="Logo" style="max-height: 50px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-4 mr-4">
              ...
              function renderSubMenu($value) {

              }

              foreach (config('navigation.menu') as $key => $menu) {

                $active = ($currentUrl == $menu['url']) ? 'active' : '';
                $hasSub = (!empty($menu['sub_menu'])) ? 'dropdown' : '';
